 ...
 * </p>
 * <ul>
 *   <li>{@link assignment1.sp.impl.SemesterImpl#getSeason <em>Season</em>}</li>
 *   <li>{@link assignment1.sp.impl.SemesterImpl#getProgramme <em>Programme</em>}</li>
 *   <li>{@link assignment1.sp.impl.SemesterImpl#getCourses <em>Courses</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemesterImpl extends MinimalEObjectImpl.Container implements Semester {
	...
	public void setSeason(SemesterType newSeason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment1Package.SEMESTER__SEASON, oldSeason,
					season));
	}
	...
	public Programme getProgramme() {
		if (eContainerFeatureID() != Assignment1Package.SEMESTER__PROGRAMME)
			return null;
	...
	public NotificationChain basicSetProgramme(Programme newProgramme, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newProgramme, Assignment1Package.SEMESTER__PROGRAMME, msgs);
		return msgs;
	}
	...
	public void setProgramme(Programme newProgramme) {
		if (newProgramme != eInternalContainer()
				|| (eContainerFeatureID() != Assignment1Package.SEMESTER__PROGRAMME && newProgramme != null)) {
			...
			if (newProgramme != null)
				msgs = ((InternalEObject) newProgramme).eInverseAdd(this, Assignment1Package.PROGRAMME__SEMESTERS,
						Programme.class, msgs);
			msgs = basicSetProgramme(newProgramme, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment1Package.SEMESTER__PROGRAMME, newProgramme,
					newProgramme));
	}
	...
	public EList<Course> getCourses() {
		if (courses == null) {
			courses = new EObjectResolvingEList<Course>(Course.class, this, Assignment1Package.SEMESTER__COURSES);
		}
		return courses;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Assignment1Package.SEMESTER__PROGRAMME:
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case Assignment1Package.SEMESTER__PROGRAMME:
			return eInternalContainer().eInverseRemove(this, Assignment1Package.PROGRAMME__SEMESTERS, Programme.class,
					msgs);
		}
