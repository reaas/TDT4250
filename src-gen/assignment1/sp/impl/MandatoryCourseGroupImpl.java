 ...
 * </p>
 * <ul>
 *   <li>{@link assignment1.sp.impl.MandatoryCourseGroupImpl#getCourses <em>Courses</em>}</li>
 *   <li>{@link assignment1.sp.impl.MandatoryCourseGroupImpl#getProgramme <em>Programme</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MandatoryCourseGroupImpl extends MinimalEObjectImpl.Container implements MandatoryCourseGroup {
	...
	protected EClass eStaticClass() {
		return Assignment1Package.Literals.MANDATORY_COURSE_GROUP;
	}
	...
	public EList<Course> getCourses() {
		if (courses == null) {
			courses = new EObjectContainmentEList<Course>(Course.class, this,
					Assignment1Package.MANDATORY_COURSE_GROUP__COURSES);
		}
		return courses;
	}
			...
			if (programme != oldProgramme) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Assignment1Package.MANDATORY_COURSE_GROUP__PROGRAMME, oldProgramme, programme));
			}
		}
		return programme;
	}
	...
	public NotificationChain basicSetProgramme(Programme newProgramme, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Assignment1Package.MANDATORY_COURSE_GROUP__PROGRAMME, oldProgramme, newProgramme);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newProgramme != programme) {
			...
			if (programme != null)
				msgs = ((InternalEObject) programme).eInverseRemove(this,
						Assignment1Package.PROGRAMME__MANDATORY_COURSES, Programme.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Assignment1Package.MANDATORY_COURSE_GROUP__PROGRAMME,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Assignment1Package.MANDATORY_COURSE_GROUP__PROGRAMME:
			if (programme != null)
				msgs = ((InternalEObject) programme).eInverseRemove(this,
						Assignment1Package.PROGRAMME__MANDATORY_COURSES, Programme.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Assignment1Package.MANDATORY_COURSE_GROUP__COURSES:
